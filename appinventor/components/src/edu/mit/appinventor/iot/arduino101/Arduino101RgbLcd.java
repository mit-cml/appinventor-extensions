...
@DesignerComponent(version = 1,
    description = "The Arduino 101 RGB LCD lets users communicate information on a liquid crystal " +
        ...
        "href='http://iot.appinventor.mit.edu/assets/samples/Arduino101RgbLcd.aia' " +
...
public class Arduino101RgbLcd extends Arduino101ExtensionBase {
  ...
  public Arduino101RgbLcd(Form form) {
    super(form);
  }
