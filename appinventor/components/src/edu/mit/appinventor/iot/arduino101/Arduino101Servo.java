...
@DesignerComponent(version = 1,
    description = "The Arduino 101 Servo extension lets users remotely control servos connected to" +
        "an Arduino 101.<br>\n\n<strong>More Links</strong><ul><li>Download a <a " +
        "href='http://iot.appinventor.mit.edu/assets/samples/Arduino101Servo.aia' " +
        "target='_blank'>sample project</a> for the Arduino 101 Servo.</li><!--<li>View the <a " +
        "href='http://iot.appinventor.mit.edu/assets/howtos/MIT_App_Inventor_IoT_Servo.pdf' " +
        "target='_blank'>how to instructions</a> for the Arduino 101 Servo.</li>--></ul>",
...
public class Arduino101Servo extends Arduino101ExtensionBase {
  ...
  public Arduino101Servo(Form form) {
    super(form);
  }
