...
@DesignerComponent(version = 1,
    description = "The Arduino101Button component lets users listen to events triggered by a " +
        ...
        "href='http://iot.appinventor.mit.edu/assets/samples/Arduino101Button.aia' " +
        "target='_blank'>sample project</a> for the Arduino 101 Button.</li><li>View the <a " +
...
public class Arduino101Button extends Arduino101ExtensionWithPin<Arduino101Button> {
  ...
  public Arduino101Button(Form form) {
    super(form, DIGITAL);
  }
