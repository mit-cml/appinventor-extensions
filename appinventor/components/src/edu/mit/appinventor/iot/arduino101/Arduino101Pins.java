...
@DesignerComponent(version = 1,
    description = "The Arduino101Pins extension provides a general purpose interface to any " +
        ...
        "href='http://iot.appinventor.mit.edu/assets/samples/Arduino101Pins.aia' " +
        "target='_blank'>sample project</a> for the Arduino 101 Pins.</li><li>View the <a " +
        "href='http://iot.appinventor.mit.edu/assets/howtos/MIT_App_Inventor_IoT_Pins.pdf' " +
        "target='_blank'>how to instructions</a> for the Arduino 101 Pins extension.</li></ul>-->"
        */,
...
public class Arduino101Pins extends Arduino101ExtensionBase {
   ...
   */
  public Arduino101Pins(Form form) {
    super(form);
  }
  ...
  @SimpleProperty(description = "Set or get whether the pin is an input or output pin. This only " +
      ...
      "href=\"#/component/arduinopwm\">Arduino 101 PWM</a> extension for treating digital pins " +
